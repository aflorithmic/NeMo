...
def parse_args():
    ...
    parser.add_argument(
        "--input_case", help="input capitalization", choices=["lower_cased", "cased", "caps"], default="cased", type=str
    )
    parser.add_argument("--whitelist", help="path to whitelist", required=False, type=str)
